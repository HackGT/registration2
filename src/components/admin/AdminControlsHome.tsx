...
const AdminControlsHome: React.FC = () => (
  ...
  >
    ...
    <Stack spacing={4} marginX={{ base: 4, md: 0 }}>
      <AdminWidget title="Autoranker" description="example description" />
      <AdminWidget title="Statistics" description="example description" />
      <AdminWidget title="Applicants" description="example description" />
      <AdminWidget title="Emailing" description="example description" />
      <AdminWidget title="Internal Settings" description="example description" />
    </Stack>
  </Flex>
);
